...
# Pre-install step: check for and remove any esbuild binary files using rm -f to prevent ETXTBSY errors
RUN (which esbuild >/dev/null 2>&1 && rm -f "$(which esbuild)" || true) \
    && rm -f /app/node_modules/esbuild/bin/esbuild \
    && rm -f /app/node_modules/@esbuild/*/bin/esbuild \
    && rm -f /app/node_modules/tsx/node_modules/esbuild/bin/esbuild \
    && rm -rf /app/node_modules/esbuild /app/node_modules/@esbuild /app/node_modules/tsx/node_modules/esbuild /tmp/* /root/.npm/_cacache 2>/dev/null || true
