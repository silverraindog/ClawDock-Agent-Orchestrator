...
export const INITIAL_UPDATES: SystemUpdateItem[] = [
  ...
  },
  {
    ...
    packageOrImage: 'openclaw/openclaw:v2.0.0',
    description: 'Extensible multi-channel agent gateway connecting 16+ chat platforms (Telegram, Discord, Slack, Matrix) with Agent Fleet coordination.',
    ...
    changelogSummary: [
      ...
      'Enterprise Tools profile with QuickJS-WASI Code Mode & Web Search',
      'Dynamic version detector & automatic v1 <-> v2 configuration converter'
    ],
    availableVersions: [
      {
        version: 'v2.0.0',
        releaseDate: 'Sep 10, 2026',
        releaseNotes: 'Major v2.0 Architecture: Multi-Agent Fleets, Unified Model Catalog, OTel Diagnostics, Web Search & Code Mode RFC-Draft 07 Config Format.',
        isLatest: true,
        channel: 'stable'
      },
      {
        ...
        releaseNotes: 'OpenClaw v1.4.1: WhatsApp clustering, Matrix crypto v2, Webhook HMAC verification.',
        isCurrent: true,
        channel: 'stable'
      },
      {
      ...
      },
      {
        ...
        releaseNotes: 'Gateway daemon v1.2 legacy LTS.',
        channel: 'stable'
      }
    ]
  },
