...
import { OPENCLAW_V2_CONFIG_DEFAULT } from './openclawSchema';
...
export const DEFAULT_CONFIGS: Record<AgentId, AgentFullConfig> = {
  ...
  'openclaw': {
    ...
    moa: {
      enabled: false,
      proposerModels: ['hermes3-8b-332k:latest', 'gemma4:12b', 'qwen2.5-coder:14b'],
      aggregatorModel: 'hermes3-8b-332k:latest',
      rounds: 1,
      temperatureSpread: 0.2,
      consensusThreshold: 0.80
    },
...
export const MODEL_OPTIONS = {
  ...
  ollama: [
    { value: 'hermes3-8b-332k:latest', label: 'Hermes 3 8B 332k (OpenClaw Default Local)' },
    { value: 'gemma4:12b', label: 'Gemma 4 12B (262k ctx, Multimodal)' },
    { value: 'gemma4:12b-65k', label: 'Gemma 4 12B 65k (Multimodal)' },
    { value: 'deepseek-coder-v2:16b', label: 'DeepSeek Coder V2 16B (163k ctx)' },
    { value: 'gemma4:e2b', label: 'Gemma 4 e2B (131k ctx, Multimodal)' },
    { value: 'gemma4:e2b-65k', label: 'Gemma 4 e2B 65k (Multimodal)' },
    { value: 'qwen3:8b', label: 'Qwen 3 8B (40k ctx, Reasoning)' },
    { value: 'qwen2.5-coder:14b', label: 'Qwen 2.5 Coder 14B (32k ctx)' },
    { value: 'qwen2.5-coder:7b', label: 'Qwen 2.5 Coder 7B (Sipeed Edge)' },
    { value: 'llama3.1:8b-instruct-q8_0', label: 'Llama 3.1 8B Instruct Q8_0 (131k ctx)' },
    { value: 'huihui_ai/gemma-4-abliterated:12b', label: 'Gemma 4 Abliterated 12B (131k ctx)' },
    { value: 'phi3:3.8b-mini-128k-instruct-q4_K_M', label: 'Phi-3 3.8B Mini 128k' },
    { value: 'gemma4-soul:latest', label: 'Gemma 4 Soul Latest (Local Edge)' },
    { value: 'ornith-9b-64k:latest', label: 'Ornith 9B 64k (262k ctx)' },
  ...
  custom: [
    { value: 'custom-model', label: 'Custom Model (Specify below or probe endpoint)' }
  ]
};
...
env:
  ...
  'openclaw': {
    ...
    format: 'json',
    content: JSON.stringify(OPENCLAW_V2_CONFIG_DEFAULT, null, 2)
  },
  'openclaw-v1': {
